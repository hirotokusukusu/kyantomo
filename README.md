...
Run `bun run start-web` to test in a web browser.

- If the browser doesn't open automatically, open: **http://localhost:8081**
- On Windows (PowerShell), if you get a firewall prompt, allow access for local networks

Note: The browser preview is great for quick testing, but some native features may not be available.
